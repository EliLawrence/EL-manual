...
`r fontawesome::fa(name="youtube", fill="red", prefer_type="solid")` See the [OBIS YouTube](https://www.youtube.com/playlist?list=PLlgUwSvpCFS4TS7ZN0fhByj_3EBZ5lXbF) playlist for many helpful How-to videos!
